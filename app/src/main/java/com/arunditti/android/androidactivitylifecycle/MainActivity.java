package com.arunditti.android.androidactivitylifecycle;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static ArrayList<String> mLifecyclesCallbacks = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i = mLifecyclesCallbacks.size() - 1; i >= 0; i--) {
            mLifecycleDisplay.append(mLifecyclesCallbacks.get(i) + "\n");
        }

        // COMPLETED (5) Clear mLifecycleCallbacks after iterating through it
        mLifecyclesCallbacks.clear();
    ...
    protected void onStop() {
        ...
        mLifecyclesCallbacks.add(0, ON_STOP);
     ...
     * temporarily destroying this instance of the activity to save space. We can distinguish
    ...
    protected void onDestroy() {
        ...
        mLifecyclesCallbacks.add(0, ON_DESTROY);
    ...
    /**
     * Logs to the console and appends the lifecycle method name to the TextView so that we can
